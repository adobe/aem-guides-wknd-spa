...
MapTo('wknd-spa-angular/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('wknd-spa-angular/components/teaser')(TeaserV1Component, {isEmpty: TeaserV1IsEmptyFn});
MapTo('wknd-spa-angular/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});
MapTo('wknd-spa-angular/components/separator')(SeparatorV1Component);


MapTo('wknd-spa-angular/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('wknd-spa-angular/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('wknd-spa-angular/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('wknd-spa-angular/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn})
MapTo('wknd-spa-angular/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('wknd-spa-angular/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});

MapTo('wknd-spa-angular/components/carousel')(CarouselV1Component);
MapTo('wknd-spa-angular/components/accordion')(AccordionV1Component);
MapTo('wknd-spa-angular/components/tabs')(TabsV1Component);
